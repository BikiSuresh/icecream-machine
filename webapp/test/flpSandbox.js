		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapuicustomicecreammachine-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapuicustomicecreammachine-display": {
								"semanticObject": "sapuicustomicecreammachine",
								"action": "display",
								"description": "Ice Creame Machine",
								"title": "Ice cream machine",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ui.custom.icecreammachine",
									"url": sap.ui.require.toUrl("sap/ui/custom/icecreammachine")
								}
							}
						}
					}
